                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            @php
                            $partes = explode(' ', trim(Auth::user()->name));
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                {{-- Avatar --}}
                                <div
                                    class="w-13 h-13 rounded-full bg-gradient-to-br from-blue-600 to-indigo-600 flex items-center justify-center text-white font-bold text-lg shadow-md">
